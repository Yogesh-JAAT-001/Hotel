            ...
            <div class="row">
                ...
                <div class="col-lg-2 col-md-6 mb-4">
                    ...
                    <ul class="list-unstyled">
                        <li><a href="<?php echo appPath('/index.php'); ?>" class="text-light text-decoration-none">Home</a></li>
                        ...
                        <li><a href="<?php echo appPath('/user/reservations.php'); ?>" class="text-light text-decoration-none">Bookings</a></li>
                        <li><a href="<?php echo appPath('/user/dashboard.php'); ?>" class="text-light text-decoration-none">Dashboard</a></li>
