    ...
    <?php if (empty($foodList['rows'])): ?>
        <div class="card card-luxury">
            <div class="card-body text-center py-5">
                <img src="<?php echo htmlspecialchars(appPath('/IMAGES/live/food/default_food.jpg')); ?>" alt="No food" style="width: 120px; border-radius: 12px; opacity: 0.8;">
...
async function handleFoodCardImageError(imageEl, foodId) {
    const fallback = '<?php echo htmlspecialchars(appPath('/IMAGES/live/food/default_food.jpg')); ?>';
