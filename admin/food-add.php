            ...
            <form method="post" enctype="multipart/form-data" class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <div class="border rounded p-2 bg-light" style="min-height: 220px;">
                        <img
                            id="imagePreview"
                            src="<?php echo htmlspecialchars(appPath('/IMAGES/live/food/default_food.jpg')); ?>"
                            alt="Image Preview"
...
input.onchange = function () {
    if (!this.files || !this.files[0]) {
        preview.src = '<?php echo htmlspecialchars(appPath('/IMAGES/live/food/default_food.jpg')); ?>';
        return;
    }
