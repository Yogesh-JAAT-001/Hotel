...
try {
    ...
    foreach ($rows as $item) {
        ...
        $item['description'] = stripUiSeedPrefix((string)($item['description'] ?? ''));
        $item['title'] = stripUiSeedPrefix((string)($item['title'] ?? ''));
...
$menu_image_fallback = appUrl(diningFallbackPath('Main Course'));
$dining_hero_image = appPath('/IMAGES/live/hero/HOTEL.png');
...
function proceedToOrder() {
    ...
    showToast('Dining selections can be linked to your reservation during checkout.', 'info');
}
