    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav me-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo appPath('/user/reservations.php'); ?>">Bookings</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo appPath('/user/dashboard.php'); ?>">Dashboard</a>
                </li>
                <li class="nav-item">
...
<div class="container-fluid p-0" style="margin-top: 76px;">
    ...
    <div id="roomContent" style="display: none;">
        ...
        <section class="position-relative" style="height: 60vh; overflow: hidden;">
            <img id="roomHeroImage" src="" alt="Room Image" class="w-100 h-100" style="object-fit: cover;" onerror="this.onerror=null;this.src='<?php echo appPath('/IMAGES/live/rooms/suite/suite-room.png'); ?>';">
...
const roomImageFallbackUrl = <?php echo json_encode(appUrl('/IMAGES/live/rooms/suite/suite-room.png')); ?>;

function stripUiSeedLabel(value) {
    return String(value ?? '').replace(/^\s*\[UI-SEED\]\s*/i, '').trim();
}
...
function displayRoomDetails(room) {
    ...
    document.getElementById('roomDescription').textContent = stripUiSeedLabel(room.description || 'Comfortable and well-appointed room with modern amenities.');
