...
const roomImageFallback = <?php echo json_encode(appUrl('/IMAGES/live/rooms/standard/standard-room.png')); ?>;
...
function buildRoomCard(room) {
    ...
    const safeDescription = escapeHtml(stripUiSeedLabel(room.description || 'Comfort-focused accommodation with curated in-room amenities.'));
