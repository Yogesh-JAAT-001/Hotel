    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav me-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="reservations.php">Bookings</a>
                </li>
                <li class="nav-item">
            ...
            <div class="col-lg-4 mb-4">
                <div class="card card-luxury sticky-top" style="top: 100px;">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text"><?php echo htmlspecialchars(stripUiSeedPrefix((string)($room['description'] ?: 'Comfortable and well-appointed room with modern amenities.'))); ?></p>
